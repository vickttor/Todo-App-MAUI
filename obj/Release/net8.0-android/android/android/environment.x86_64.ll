...
@dso_cache = dso_local local_unnamed_addr global [486 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4454802137055669346, ; hash 0x3dd2a2f0ebdaac62, from name: maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 113
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6095831501591254889, ; hash 0x5498be741efb9769, from name: libaot-maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 140
	...
	%struct.DSOCacheEntry {
		i64 7257483083518000381, ; hash 0x64b7c269a47f3cfd, from name: maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 166
	...
	%struct.DSOCacheEntry {
		i64 7288421994652466234, ; hash 0x6525ad303c677c3a, from name: aot-maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 169
	...
	%struct.DSOCacheEntry {
		i64 9979284601398715424, ; hash 0x8a7d8a78f2e56420, from name: libaot-maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 254
	...
	%struct.DSOCacheEntry {
		i64 15112322810033820911, ; hash 0xd1b9c186f71954ef, from name: aot-maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 399
...
@.env.3 = private unnamed_addr constant [37 x i8] c"561f6055-139d-4550-9f02-d31ac870cbc7\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [19 x i8] c"libaot-maui.dll.so\00", align 16
...
@.DSOCacheEntry.58_name = private unnamed_addr constant [43 x i8] c"libaot-System.IO.Compression.Brotli.dll.so\00", align 16
@.DSOCacheEntry.59_name = private unnamed_addr constant [36 x i8] c"libaot-System.IO.Compression.dll.so\00", align 16
